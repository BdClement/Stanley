    ...
    return (
        <div className="flex flex-grow">
            <div className="m-4 flex flex-col flex-grow">
                ...
                <ul className=" flex flex-col flex-gro">
                    <li className="flex-grow hover:underline">Qui sommes nous ?</li>
                    <li className="flex-grow hover:underline">Nos valeurs</li>
                    <li className="flex-grow hover:underline">FAQ</li>
                </ul>
            </div>
            <div className="m-4 flex flex-col flex-grow">
                <div className="h-[2px] w-3/4 bg-gradient-to-r from-brun-contrast to-brun-contrast-300"></div>
