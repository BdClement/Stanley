function Faq() {
    return (
        ...
        <div className="min-h-screen flex flex-col gap-4 lg:gap-8 xl:gap-12 py-[5vh] xl:py-[10vh] 2xl:py[15vh] px-[5vw] xl:px-[8vw] opacity-0 animate-zoom-in text-justify text-brun-contrast">
            ...
            <div>
                <h3 className="font-semibold text-brun-main uppercase">Quels types de menuiseries propose Menuitek ?</h3>
            ...
            <div>
                <h3 className="font-semibold text-brun-main uppercase">En quoi les produits Menuitek se distinguent-ils ?</h3>
            ...
            <div>
                <h3 className="font-semibold text-brun-main uppercase">Intervenez-vous uniquement en France ?</h3>
            ...
            <div>
                <h3 className="font-semibold text-brun-main uppercase">Comment se déroule une commande chez Menuitek ?</h3>
            ...
            <div>
                <h3 className="font-semibold text-brun-main uppercase">Proposez-vous la pose ou uniquement la fourniture des menuiseries ?</h3>
            ...
            <div>
                <h3 className="font-semibold text-brun-main uppercase">Quel matériau choisir : aluminium, PVC ou bois ?</h3>
            ...
            <div>
                <h3 className="font-semibold text-brun-main uppercase">Quels sont les délais de fabrication et de livraison ?</h3>
            ...
            <div>
                <h3 className="font-semibold text-brun-main uppercase">Vos produits sont-ils garantis ?</h3>
            ...
            <div>
                <h3 className="font-semibold text-brun-main uppercase">Puis-je obtenir un devis gratuitement ?</h3>
            ...
            <div>
                <h3 className="font-semibold text-brun-main uppercase">Travaillez-vous avec les promoteurs et architectes ?</h3>
