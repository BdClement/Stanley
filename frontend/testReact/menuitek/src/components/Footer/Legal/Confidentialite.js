function Confidentialite() {
    return (
        <div className="min-h-screen flex flex-col gap-4 lg:gap-8 xl:gap-12 py-[5vh] xl:py-[10vh] 2xl:py[15vh] px-[5vw] xl:px-[8vw] opacity-0 animate-zoom-in">
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>1 - Données collectées</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>2 - Finalité de la collecte</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>3 - Base légale du traitement</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>4 - Destinataires des données</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>5 - Durée de conservation</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>6 - Cookies</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>7 - Vos droits</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>8 - Coordonnées du responsable du traitement</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>9 - Sécurité des données</h3>
