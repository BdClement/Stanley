function Mentions() {
    return (
        <div className="min-h-screen flex flex-col gap-4 lg:gap-8 xl:gap-12 py-[5vh] xl:py-[10vh] 2xl:py[15vh] px-[5vw] xl:px-[8vw] opacity-0 animate-zoom-in">
            <h1 className='font-semibold text-brun-contrast uppercase text-center'>Mentions légales</h1>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>2 - Hébergement</h3>
                <ul className="list-inside p-4">
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>3 - Propriété intellectuelle</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>4 - Crédits</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>5 - Responsabilité</h3>
            ...
            <div>
                <h3 className='font-semibold text-brun-contrast uppercase'>6 - Contact</h3>
