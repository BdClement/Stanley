    ...
    return (
        <div className='flex flex-col gap-4 lg:gap-8 xl:gap-12 py-[5vh] xl:py-[10vh] 2xl:py[15vh] px-[5vw] xl:px-[8vw] bg-gradient-to-t from-grey-main to-grey-contrast/30 text-xs md:text-sm lg:text-base xl:text-xl 2xl:text-2xl'>
            ...
            <ul className='flex flex-wrap min-h-[35vh] justify-evenly gap-6 py-6 lg:py-12 xl:py-20 border-t border-grey-contrast/70'>
                <li className='flex flex-col justify-evenly w-full sm:w-[48%] lg:w-[22%] h-[18vh] md:h-[24vh] lg:h-[35vh] xl:h-[55vh] 2xl:h-[60vh] p-4 rounded-md bg-cover bg-center hover:scale-105 transition duration-300' style={{ backgroundImage: `url(${window})`}}>
                ...
                <li className='flex flex-col justify-evenly w-full sm:w-[48%] lg:w-[22%] h-[18vh] md:h-[24vh] lg:h-[35vh] xl:h-[55vh] 2xl:h-[60vh] p-4 rounded-md bg-cover hover:scale-105 transition duration-300' style={{ backgroundImage: `url(${volets})`}}>
                    <div className='flex flex-col justify-evenly w-[80%] lg:w-[100%] h-[100%] md:h-[90%] xl:h-[60%] bg-white/30 backdrop-blur-sm text-grey-main rounded-md p-2'>
                ...
                <li className='flex flex-col justify-evenly relative w-full sm:w-[48%] lg:w-[22%] h-[18vh] md:h-[24vh] lg:h-[35vh] xl:h-[55vh] 2xl:h-[60vh] p-4 rounded-md bg-cover bg-center hover:scale-105 transition duration-300' style={{ backgroundImage: `url(${porte})`}}>
                    <div className='flex flex-col justify-evenly w-[80%] lg:w-[100%] h-[100%] md:h-[90%] xl:h-[60%] bg-white/30 backdrop-blur-sm text-grey-main rounded-md p-2'>
            ...
            <p>Autre information importante sur les produits proposés à placer ici ?</p>
        </div>
    )
}
