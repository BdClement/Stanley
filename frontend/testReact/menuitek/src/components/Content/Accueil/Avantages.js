...
function Avantages() {
    return (
        ...
        <div className='flex flex-col gap-4 lg:gap-8 xl:gap-12 min-h-[70vh] py-[5vh] xl:py-[10vh] 2xl:py[15vh] px-[5vw] xl:px-[8vw] rounded-[0%_0%_50%_50%_/_25%_25%_5%_5%] bg-gradient-to-b from-beige to-brun-contrast/30 border-t border-brun-contrast/40'>
            <p className='font-bold text-brun-main'>LES AVANTAGES MENUITEK</p>
            <ul className='flex flex-wrap justify-between gap-4 lg:gap-8 2xl:gap-12 py-4 lg:py-8 2xl:py-20'>
                <li className='flex flex-col justify-evenly items-center w-full sm:w-[48%] lg:w-[30%] min-h-[12vh] md:min-h-[18vh] lg:min-h-[24vh] xl:min-h-[28vh]'>
                    <h3 className='font-bold'>Rapport qualité/prix</h3>
                ...
                <li className='flex flex-col justify-evenly items-center w-full sm:w-[48%] lg:w-[30%] min-h-[12vh] md:min-h-[18vh] lg:min-h-[24vh] xl:min-h-[28vh]'>
                    <h3 className='font-bold'>Accompagement personnalisé</h3>
                    <div className='flex flex-col flex-grow justify-evenly items-center'>
                ...
                <li className='flex flex-col justify-evenly items-center w-full sm:w-[48%] lg:w-[30%] min-h-[12vh] md:min-h-[18vh] lg:min-h-[24vh] xl:min-h-[28vh]'>
                    <p className='font-bold'>Expertise et savoir-faire</p>
                    <div className='flex flex-col flex-grow justify-evenly items-center'>
                ...
                <li className='flex flex-col justify-evenly items-center w-full sm:w-[48%] lg:w-[30%] min-h-[12vh] md:min-h-[18vh] lg:min-h-[24vh] xl:min-h-[28vh]'>
                    <p className='font-bold'>Reactivité et délais matrisés</p>
                    <div className='flex flex-col flex-grow justify-evenly items-center'>
                ...
                <li className='flex flex-col justify-evenly items-center w-full sm:w-[48%] lg:w-[30%] min-h-[12vh] md:min-h-[18vh] lg:min-h-[24vh] xl:min-h-[28vh]'>
                    <p className='font-bold'>Offre fournie et personnalisable</p>
                    <div className='flex flex-col flex-grow justify-evenly items-center'>
                ...
                <li className='flex flex-col justify-evenly items-center w-full sm:w-[48%] lg:w-[30%] min-h-[12vh] md:min-h-[18vh] lg:min-h-[24vh] xl:min-h-[28vh]'>
                    <p className='font-bold'>Performance et durabilité</p>
                    <div className='flex flex-col flex-grow justify-evenly items-center'>
                ...
                <li className='flex flex-col justify-evenly items-center w-full sm:w-[48%] lg:w-[30%] min-h-[12vh] md:min-h-[18vh] lg:min-h-[24vh] xl:min-h-[28vh]'>
                    <p className='font-bold'>Engagement qualité</p>
                    <div className='flex flex-col flex-grow justify-evenly items-center'>
