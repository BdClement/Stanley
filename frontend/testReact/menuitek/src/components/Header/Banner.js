...
function Banner() {
    return (
        <div className='flex flex-row min-h-[10vh] max-h-[12vh] items-center xl:px-32'>
            ...
            <h1 className='font-comforta text-[clamp(0.9rem,2vw,2.2rem)] flex-1 text-center break-words text-beige-main'>Avec vous,<br />Pour tous vos projets de Rénovation</h1>
